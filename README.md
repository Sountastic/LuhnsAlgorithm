# Luhn's Algorithm
Prosta implementacja algorytmu Luhna w Javie
Algorytm przebiega nastepujaco: 
...
2. Każdą cyfrę liczby mnoży się przez odpowiadającą jej wagę od prawej do lewej .
